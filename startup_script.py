...
if __name__ == "__main__":
    ...
    asyncio.run(register_env("11_vs_11_stochastic"))  # Google Football Environment
    ...
    asyncio.run(register_experiment("Google Football", env_id="11_vs_11_stochastic"))  # Google Football Experiment
