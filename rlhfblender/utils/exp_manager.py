...
class ExperimentManager:
    ...
    def __init__(
        ...
        self.norm_logging = norm_logging
    ...
    def create_envs(self, n_envs: int, eval_env: bool = False, no_log: bool = False) -> VecEnv:
        ...
        if self.use_trained_reward_function:
            if self.verbose >= 1:
                print("Wrapping the env in RewardVecEnvWrapper")
            env = RewardVecEnvWrapper(env, self.trained_reward_function_path)
